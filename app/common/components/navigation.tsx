        ...
        <div className="flex items-center gap-2">
          <Button size="icon" variant="ghost" asChild className="relative">
            <Link to="/my/notifications">
              ...
              {hasNotifications && (
                <div className="absolute top-1.5 right-1.5 bg-red-500 text-white text-xs rounded-full size-2 flex items-center justify-center" />
              )}
            </Link>
          </Button>
          <Button size="icon" variant="ghost" asChild className="relative">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-64">
              <DropdownMenuLabel className="flex flex-col">
                <span className="font-medium">HG</span>
