...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      teams: {
        Row: {
          ...
          product_name: string
          product_state: Database["public"]["Enums"]["product_state"]
          roles: string
          team_id: number
          team_size: number
          updated_at: string
    ...
    Enums: {
      ...
      notification_type: "follow" | "review" | "replay" | "mention"
      product_state: "idea" | "prototype" | "mvp" | "product"
      role:
        | "developer"
        | "designer"
        | "marketer "
...
export const Constants = {
  public: {
    Enums: {
      ...
      notification_type: ["follow", "review", "replay", "mention"],
      product_state: ["idea", "prototype", "mvp", "product"],
      role: ["developer", "designer", "marketer ", "founder", "product-manger"],
      salary_range: [
        "$0 - $50,000",
        "$50,000 - $70,000",
        "$70,000 - $100,000",
