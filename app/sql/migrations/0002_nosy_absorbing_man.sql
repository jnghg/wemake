...
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_review_id_products_product_id_fk" FOREIGN KEY ("review_id") REFERENCES "public"."products"("product_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
